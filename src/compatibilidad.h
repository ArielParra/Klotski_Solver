#pragma once //para que no de problemas de compilación por inclusion multiple
...
inline void clrscr() {system("cls");}
    ...
    //En sistemas basados en Unix el sistema suele ya soportar esto asi que es implícito
